          ...
          , g = function(e) {
            ...
            u(t, [{
                ...
                value: function(e, t) {
                    ...
                    return ["linear", "repeating-linear"].indexOf(i) >= 0 && r.indexOf(o) >= 0 && (o = "center" === o ? "to right" : "to " + o),
                    ["radial", "repeating-radial"].indexOf(i) >= 0 && r.indexOf(o) >= 0 && (o = "circle at " + o),
                    n ? i + "-gradient(" + o + ", " + n + ")" : ""
                }
            }, {
                key: "getSafeValue",
                value: function(e, t) {
                    var n = this.previewEl
                      , i = this.getValue(e, t);
                    if (!this.sandEl && (this.sandEl = document.createElement("div")),
                    !n || !i)
                        return "";
                    for (var o = this.sandEl.style, a = [i].concat(r(this.getPrefixedValues(e, t))), l = void 0, u = 0; u < a.length && (l = a[u],
                    o.backgroundImage = l,
                    o.backgroundImage != l); u++)
                        ;
                ...
                value: function(e, t) {
                    ...
                    return !i.silent && this.emit("handler:add", r),
                    r
                }
            }, {
                key: "getHandler",
                ...
                key: "clear",
                value: function() {
                    for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = this.handlers, n = t.length - 1; n >= 0; n--)
                        t[n].remove(e)
                }
            }, {
                key: "getSelected",
          ...
          , a = function() {
            ...
            return r(e, [{
                ...
                value: function(e) {
                    ...
                    this.color = e,
                    this.emit("handler:color:change", this, t)
                }
            }, {
                key: "setPosition",
                value: function(e) {
                    ...
                    var e = this
                      ...
                      , f = function(t) {
                        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1
                          , i = t.target.value;
                        e.setColor(i, n),
                        s && (s.style.backgroundColor = i)
                    };
                    if (u && (0,
                    o.on)(u, "click", function(e) {
                        return e.stopPropagation()
                    }),
                    l && (0,
                    o.on)(l, "click", function(t) {
                        t.stopPropagation(),
                        e.remove()
                    }),
                    c && ((0,
                    ...
                    h) {
                        var d = 0
                          ...
                          , k = function(t) {
                            ...
                            (0,
                            o.isDef)(t.button) && 0 === t.which && b(t)
                        }
                          , b = function t(n) {
                            (0,
                            o.off)(document, "touchmove mousemove", k),
                            (0,
                            o.off)(document, "touchend mouseup", t),
                            p && (p = 0,
                            e.setPosition(d),
                          ...
                          , w = function(t) {
                            ...
                            o.isDef)(t.button) || 0 === t.button) {
                                ...
                                y.y = i.clientY,
                                (0,
                                o.on)(document, "touchmove mousemove", k),
                                (0,
                                o.on)(document, "touchend mouseup", b),
                                e.emit("handler:drag:start", e)
                            }
                        };
                        (0,
                        o.on)(h, "touchstart mousedown", w),
                        (0,
                        o.on)(h, "click", function(e) {
                            return e.stopPropagation()
                        })
                    }
                }
